...
from control_escolar_desit_api.views import graficas
...
urlpatterns = [
    ...
    # Materias
        ...
        path('materias/<int:id_materia>/', materias.MateriasView.as_view()),  
        path('lista-materias/', materias.MateriasAll.as_view()),

        path('usuarios/totales/', graficas.TotalesUsuariosView.as_view()),
